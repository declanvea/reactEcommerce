...
export default class BaseLayout extends React.Component {
  render(){
    return (
      <div style={{backgroundColor: '#000066', borderRadius: '0.3rem'}} className="container">
          <div className="container">
            <Navbar style={{backgroundColor:"#000066", borderTopRightRadius: '0.3rem', borderTopLeftRadius: '0.3rem'}} light toggleable>
               <NavbarToggler right />
               <NavbarBrand><NavLink exact to="/"><img style={{width:'50px'}} src="http://grfx.cstv.com/schools/pgatour/graphics/PGATOUR_Logo.png" atl="pga tour"/></NavLink></NavbarBrand>
                 <Collapse navbar>
                 <Navbar style={{backgroundColor:"#000066", borderBottomRightRadius: '0.3rem', borderBottomLeftRadius: '0.3rem'}} color="faded" light toggleable>
                   <NavbarToggler right />
                     <Nav className="ml-auto" navbar >
                       ...
                       <NavItem>
                         <NavLink style={{margin:'5px', fontFamily: 'cursive', color:'red'}} to="/usopen" activeClassName="selected">U.S. Open</NavLink>
                       </NavItem>
                       <NavItem>
        ...
        {this.props.children}
        <footer style={{backgroundColor: '#000066', display:'flex', justifyContent:'center'}} className="container">
